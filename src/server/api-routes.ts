/**
 * API route handlers for the emails HTTP server.
 * Extracted from serve.ts to keep the server entry point thin.
 *
 * All routes return Response | null. null means "no match — try next handler".
 */
...
export async function handleApiRequest(req: Request, url: URL, path: string, method: string): Promise<Response | null> {
